...
#pragma warning restore 169
    ...
    // this enables the client framework stack - necessary for access to headers
        ...
        /// <returns></returns>
        public TDTO Request<TDTO>(string target, string uriTemplate, string method, Dictionary<string, object> parameters, TimeSpan cacheDuration, string throttleScope, ContentType contentType)
        {
#if SILVERLIGHT
            ...
            BeginRequest<TDTO>(ar =>
            {
                ...
                gate.Set();
            }, null, target, uriTemplate, method, parameters, cacheDuration, throttleScope, contentType);
        ...
        public void BeginRequest<TDTO>(ApiAsyncCallback<TDTO> cb, object state, string target, string uriTemplate,
                                       string method, Dictionary<string, object> parameters, TimeSpan cacheDuration,
                                       string throttleScope, ContentType contentType)
        {
            //lock (_lockObj)
            {
                ...
                _requestController.ProcessCacheItem(target, uriTemplate, method, localParams, cacheDuration, throttleScope, url, contentType, cb, state);
            }
        }
