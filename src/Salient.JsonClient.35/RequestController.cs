...
namespace Salient.JsonClient
{
    ...
    public class RequestController : IRequestController
    {
        ...
        public void ProcessCacheItem<TDTO>(string target, string uriTemplate, string method,
                                           ...
                                           string throttleScope, string url, ContentType contentType, ApiAsyncCallback<TDTO> cb, object state)
        {
        ...
        private void EncodeAndAddItem(ref StringBuilder baseRequest, string key, string dataItem)
        {
            ...
            baseRequest.Append("=");
            baseRequest.Append(Salient.JsonClient.HttpUtility.UrlEncode(dataItem));
        }
